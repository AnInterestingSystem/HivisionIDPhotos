...
LOCALES = {
    ...
    "notification": {
        "en": {
            ...
            "no_quota_error": "No enough credit. Please visit https://app.iknow.plus/product to recharge and use.",
        ...
        "zh": {
            ...
            "no_quota_error": "ai豆不足。请访问 https://app.iknow.plus/product 充值后使用。",
        ...
        "ja": {
            ...
            "no_quota_error": "クレジットが足りません。https://app.iknow.plus/product にアクセスしてチャージして使用してください。",
        ...
        "ko": {
            ...
            "no_quota_error": "크레딧이 부족합니다. https://app.iknow.plus/product 를 방문하여 충전하고 사용하세요.",
