    ...
    with demo:
        ...
        with gr.Row():
            ...
            with gr.Column(elem_classes=["left-container"]):
                ...
                # TAB5 - 打印 ------------------------------------------------
                with gr.Tab(LOCALES["print_tab"][default_lang]["label"]) as print_parameter_tab:
                    print_options = gr.Radio(choices=LOCALES["print_switch"][default_lang]["choices"], label=LOCALES["print_switch"][default_lang]["label"], value=LOCALES["print_switch"][default_lang]["choices"][0], interactive=True, )
            ...
            def change_language(language):
                return {
                    ...
                    print_parameter_tab: gr.update(label=LOCALES["print_tab"][language]["label"]),
                    print_options: gr.update(label=LOCALES["print_switch"][language]["label"], choices=LOCALES["print_switch"][language]["choices"], value=LOCALES["print_switch"][language]["choices"][0], ),
                }
