...
def create_ui(processor: IDPhotoProcessor, root_dir: str, language: list):
    ...
    with demo:
        ...
        with gr.Row():
            ...
            with gr.Column():
                ...
                # 抠图图像
                with gr.Accordion(LOCALES["matting_image"][default_lang]["label"], open=False) as matting_image_accordion:
                    with gr.Row():
